...
awful.rules.rules = {
    ...
    { rule = { class = "Firefox", instance = "Navigator" },
      properties = { floating = false, tag=tags[math.max(1,screen.count())][2] } },
    { rule = { class = "Firefox", instance = "Firebug" },
      properties = { floating = true, tag=tags[math.max(1,screen.count())][2]} }, 
    ...
    { rule = { class = "Gvim" },
      ...
      callback = function(c) center_on_screen(c, 1, 0.70) end },
    { rule = { class = "Eclipse" },
      properties = { floating = true, tag=tags[math.min(2,screen.count())][2] } },
